...
`
	...
	os.Setenv("EP_PLATFORM", "prod")
	os.Setenv("EP_REGION", "emea")
	os.Setenv("EP_BATCH_SIZE", "2000")
	os.Setenv("EP_LOG_LEVEL", "error")

	defer func() {
		os.Unsetenv("EP_PLATFORM")
		os.Unsetenv("EP_REGION")
		os.Unsetenv("EP_BATCH_SIZE")
		os.Unsetenv("EP_LOG_LEVEL")
	}()
